...
using FoundryForge.App.Services;
...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.RegisterFoundryForgeServices();
...
public static class FoundryForgeServiceCollectionExtensions
{
    public static IServiceCollection RegisterFoundryForgeServices(this IServiceCollection services)
    {
        ...
        services.AddSingleton<FoundryForge.App.Services.SmartSearch.NlEngineResolver>();
