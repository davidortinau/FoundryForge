...
/// FoundryStudio-curated allow-list, in allow-list order. This makes NO quality claim — it is an
...
{
    /// <summary>
    /// FoundryStudio-curated starter aliases (documented, adjustable; no quality ranking implied).
